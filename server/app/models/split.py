...
class Split(Base):
    ...
    quote_status = Column(Enum(QuoteStatus), default=QuoteStatus.PENDING, comment="报价状态")
    ...
    def __repr__(self):
        return f"<Split(id={self.id}, order_number='{self.order_number}', customer='{self.customer_name}', quote_status='{self.quote_status.value}')>"