...
const DesignPage: React.FC = () => {
  ...
  const designData = [
    ...
    },
    {
      ...
      salesperson: "王销售员",
      splitTime: "2024-07-20",
      progress: "量尺:2025/07/11,初稿:2025/07/20,已报价未打款:2025/08/20,已打款,已打款,已打款,已打款",
            ...
            {displayItems.map((item, itemIndex) => {
              ...
              return (
                <div key={itemIndex}>
                  {time ? (
                    <span>
                      {status} <span style={{ fontSize: '12px', color: '#666' }}>({time})</span>
                    </span>
                  ) : (
                    <span>{status}</span>
                  )}
  ...
  return (
    <div className="space-y-4">
      {/* 搜索Card */}
      <Card variant="outlined" title="搜索条件">
      ...
      {/* 内容Card */}
      <Card variant="outlined" title="设计管理">
        {/* 新增按钮 */}
