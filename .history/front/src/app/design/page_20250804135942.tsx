...
import { Typography, Card, Table, Button, Space, Input, Select, Row, Col, Divider, Image, Tabs } from 'antd';
import { SearchOutlined, PlusOutlined, FileOutlined, PictureOutlined, AppstoreOutlined, BarsOutlined } from '@ant-design/icons';
    ...
    },
    {
      ...
      render: (_: unknown, record: Record<string, any>) => (
        <Button 
          ...
          onClick={() => handleDesignClick(record.key)}
        >
          预览
        </Button>
      ),
    ...
    return (
      <div className="bg-white p-4 rounded-lg shadow">
        <div className="flex justify-between items-center mb-4">
          <Title level={4}>{design?.designNumber} - {design?.productName}</Title>
          <Space>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <div className="bg-gray-50 p-3 rounded">
                <p><strong>客户名称:</strong> {design?.customerName}</p>
                <p><strong>设计师:</strong> {design?.designer}</p>
                <p><strong>状态:</strong> {design?.status}</p>
              </div>
            </Col>
            <Col span={12}>
              <div className="bg-gray-50 p-3 rounded">
                <p><strong>创建时间:</strong> {design?.createTime}</p>
                <p><strong>最后更新:</strong> 2024-06-25</p>
                <p><strong>设计类型:</strong> 产品设计</p>
              </div>
            </Col>
          </Row>
        </div>
              ...
              <Col span={8} key={design.key}>
                ...
                >
                  <Card.Meta
                    ...
                    description={
                      <>
                        <p>{design.productName} - {design.customerName}</p>
