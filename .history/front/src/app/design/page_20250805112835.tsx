...
import { Card, Table, Button, Space, Input, Select, Row, Col, Tag } from "antd";
...
const DesignPage: React.FC = () => {
  ...
  const [editingRecord, setEditingRecord] = useState<Record<string, string | number> | null>(null);
    ...
    <div className="space-y-6">
      ...
      <CreateOrderModal
        ...
        initialValues={editingRecord ? {
          orderNumber: editingRecord.designNumber as string,
