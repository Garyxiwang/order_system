  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-6 bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="flex w-full max-w-5xl overflow-hidden rounded-xl shadow-xl">
        {/* 左侧图片区域 */}
        <div style={{ backgroundColor: "#3e8cff" }} className="relative hidden w-1/2 md:block">
          <div className="flex h-full items-center justify-center">
            <div className="relative h-full w-full">
              <div className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-blue-700 to-indigo-600">
                <Image 
                  src="/globe.svg" 
                  alt="登录页面图片"
                  width={200}
