  ...
  useEffect(() => {
    if (orderData) {
      form.setFieldsValue({
        ...
        doorFixedDate: orderData.fixedTime ? dayjs(orderData.fixedTime) : undefined,
        cabinetSplitDate: undefined,
        cabinetFixedDate: orderData.fixedTime ? dayjs(orderData.fixedTime) : undefined,
    ...
    >
      ...
      >
        <Row gutter={24}>
          {/* 木门/柜体栏 */}
          <Col span={12}>
            <Card title="木门" size="small" style={{ marginBottom: 16 }}>
          ...
          {/* 其他项目栏 */}
          <Col span={12}>
            <Card title="石材" size="small" style={{ marginBottom: 16 }}>
            ...
            <Card title="板材" size="small" style={{ marginBottom: 16 }}>
