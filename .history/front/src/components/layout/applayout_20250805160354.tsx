        ...
        <Layout className="min-h-screen">
          <Layout>
            <Sider
              width={250}
              theme="light"
              className="fixed left-0 top-0 h-screen shadow-md z-10 bg-gradient-to-b from-blue-50 to-white overflow-y-auto"
              breakpoint="lg"
              collapsible
            >
            ...
            <Layout style={{ marginLeft: 250 }} className="min-h-screen">
              <Header
              ...
              <Content className="m-4 rounded-lg overflow-y-auto">
                {children}
              </Content>
