        ...
        <Layout className="min-h-screen">
          <Layout>
            ...
            <Layout className="bg-gray-50">
              <Header className="bg-white px-6 flex justify-between items-center shadow-sm h-16 sticky top-0 z-10">
                <div className="flex-1">
                  <Menu 
                    ...
                    items={[
                      {
                        key: "design",
                        label: <Link href="/design" className="text-gray-700 hover:text-blue-600">设计管理</Link>
                      },
                      {
                        key: "split",
                        label: <Link href="/split" className="text-gray-700 hover:text-blue-600">拆单管理</Link>
                      },
                      {
                        key: "config",
                        label: <Link href="/config" className="text-gray-700 hover:text-blue-600">系统配置</Link>
                      }
                    ]}
                  />
                </div>
              ...
              <Content className="p-6 m-4 bg-white rounded-lg shadow-sm">{children}</Content>
