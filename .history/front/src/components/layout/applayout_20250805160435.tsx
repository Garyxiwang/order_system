        ...
        <Layout className="min-h-screen">
          <Layout>
            <Sider
              width={250}
              theme="light"
              className="shadow-md z-10 bg-gradient-to-b from-blue-50 to-white"
              breakpoint="lg"
              collapsible
              style={{ height: '100vh', position: 'fixed', left: 0, top: 0, overflowY: 'auto' }}
            >
            ...
            <Layout style={{ marginLeft: 250, height: '100vh', overflow: 'hidden' }}>
              <Header
              ...
              <Content className="m-4 rounded-lg" style={{ height: 'calc(100vh - 120px)', overflowY: 'auto' }}>
                {children}
              </Content>
